...
const PropertyDetails = () => {
  ...
  const {viewListings} = useContext(HouseContext);

  return (
      <section>
        <div className='container mx-auto min-h-0[800px]
        mb-14'>
          ...
          lg:justify-between'>
            ...
            text-sm'>
              ...
              <div className='bg-violet-500 text-white px-4 rounded-full'>{house.country}</div>
            </div>
            <div className='text-3xl font-semibold text-violet-600'>EGP {house.price}</div>
          </div>
            ...
            mb-8 border border-gray-300 rounded-lg px-6 py-8'>
              <div className='flex items-center gap-x-4 mb-8'>
                ...
                <div>
                  ...
                  <Link to='/' onClick={()=>viewListings(house.agent.name)} className='text-violet-700 text-sm' >
                    View Listings
                  </Link> 
                </div>
              </div>
              <form className='flex flex-col gap-y-4'>
                ...
                resize-none rounded w-full p-4 h-36 text-sm
                text-gray-400' placeholder='Message'
                defaultValue='Hello, I am intersted in this unit'></textarea>
                <div className='flex gap-x-2'>
                  ...
                  p-4 text-sm w-full transition'>Call</button>
                </div>
              </form>
            </div>
          </div>
